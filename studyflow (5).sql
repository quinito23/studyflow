...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-05-2025 a las 13:33:49
...
(1, 'tungsahur@studyflow.com', 'asdd32dqd', 'tung', 'sahur', '12312312312', NULL, NULL),
(2, 'kinito@gmail.com', 'asdasd34', 'quinito', 'alias', '21312312', NULL, NULL),
(3, 'avita@gmail.com', 'asdasd3242', 'eevita', 'dinamita', '213123123', NULL, NULL),
(4, 'profesor@gmail.com', 'profe', 'profe', 'profe', '1123123123', NULL, NULL),
(5, 'joaquin@gmail.com', 'joaquin', 'joaquin', 'alias', '12312312', NULL, NULL),
(6, 'mariareina@gmail.com', 'maria', 'maria', 'reina', '2311231', NULL, NULL);
...
(4, 'Historia', 'Básico', 'Historia mundial del siglo XX', 41);
...
(18, NULL, '', NULL, NULL),
(37, NULL, '', NULL, NULL),
(41, '23123', 'tiempo_completo', '2025-05-12', '2025-05-15');
...
(12, 36, 1, 3, 4, '2025-05-08', '20:58:00', '21:58:00', 'activa'),
(13, 36, 1, 2, 3, '2025-05-12', '12:04:00', '13:04:00', 'activa'),
(14, 36, 2, 4, 5, '2025-05-12', '09:07:00', '13:07:00', 'activa'),
(15, 36, 1, 1, 1, '2025-05-12', '16:45:00', '18:47:00', 'activa'),
(16, 36, 1, 1, 1, '2025-05-12', '14:44:00', '15:45:00', 'activa'),
(17, 37, 1, 4, 5, '2025-05-13', '14:03:00', '15:04:00', 'activa');
...
(5, 5, 'rechazado', '2025-05-08', 'profesor'),
(6, 6, 'aceptado', '2025-05-08', 'alumno');
...
INSERT INTO `tarea` (`id_tarea`, `id_usuario`, `descripcion`, `fecha_creacion`, `fecha_entrega`) VALUES
(1, 36, 'hoola', '2025-05-09 11:39:19', '2025-05-11 12:40:00'),
(2, 36, 'holaaaaa', '2025-05-09 11:39:53', '2025-05-10 14:42:00'),
(4, 37, 'hols', '2025-05-12 13:18:32', '2025-05-13 14:19:00');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tarea_asignatura`
--
...
--
-- Volcado de datos para la tabla `tarea_asignatura`
--
...
--
-- Estructura de tabla para la tabla `tarea_grupo`
--
...
--
-- Volcado de datos para la tabla `tarea_grupo`
--

INSERT INTO `tarea_grupo` (`id_tarea`, `id_grupo`) VALUES
(1, 3),
(2, 4),
(4, 3);
...
(40, 'maria', 'reina', '', '2311231', 'mariareina@gmail.com', 'maria', NULL, 'alumno'),
(41, 'rauk', 'oteero', '22713791A', '+34 735614261', 'raul@gmail.com', 'Melilla15694586', '1997-07-12', 'profesor'),
(42, 'hicham', 'aslani', '20266551D', '+34792181204', 'hicham@gmail.com', 'Hicha12312312', '2004-06-12', 'alumno');
...
--
-- Indices de la tabla `tarea_asignatura`
--
ALTER TABLE `tarea_asignatura`
  ADD PRIMARY KEY (`id_tarea`,`id_asignatura`),
  ADD KEY `id_asignatura` (`id_asignatura`);

--
-- Indices de la tabla `tarea_grupo`
--
ALTER TABLE `tarea_grupo`
  ADD PRIMARY KEY (`id_tarea`,`id_grupo`),
...
--
ALTER TABLE `anonimo`
  MODIFY `id_anonimo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- Filtros para la tabla `tarea_asignatura`
--
ALTER TABLE `tarea_asignatura`
  ADD CONSTRAINT `tarea_asignatura_ibfk_1` FOREIGN KEY (`id_tarea`) REFERENCES `tarea` (`id_tarea`) ON DELETE CASCADE,
  ADD CONSTRAINT `tarea_asignatura_ibfk_2` FOREIGN KEY (`id_asignatura`) REFERENCES `asignatura` (`id_asignatura`) ON DELETE CASCADE;

--
-- Filtros para la tabla `tarea_grupo`
--
ALTER TABLE `tarea_grupo`
  ADD CONSTRAINT `tarea_grupo_ibfk_1` FOREIGN KEY (`id_tarea`) REFERENCES `tarea` (`id_tarea`) ON DELETE CASCADE,
  ADD CONSTRAINT `tarea_grupo_ibfk_2` FOREIGN KEY (`id_grupo`) REFERENCES `grupo` (`id_grupo`) ON DELETE CASCADE;
COMMIT;
