...
<body>
    ...
    <header class="header">
        ...
        <div class="d-flex align-items-center navbar-dark">
            <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasSidebar" aria-label="Toggle Navigation">
    ...
    <main class="main-content">
        ...
        <form id="reservas-form" class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="date" class="form-control" id="hora_inicio" required>
            </div>
            <div class="col-md-6">
                <label for="hora_fin" class="form-label">Hora de Finalización:</label>
                <input type="date" class="form-control" id="hora_fin" required>
            </div>
            <div class="col-md-6">
                <label for="aula" class="form-label">Aula:</label>
                <select id="aula" class="form-select" multiple>
                    <!--Aquí serán listadas las aulas disponibles para elegir-->
                </select>
            </div>
            <div class="col-md-6">
                <label for="asignatura" class="form-label">Asignatura:</label>
                <select id="asignatura" class="form-select" multiple>
                    <!--Aquí serán listados las asignaturas disponibles a elegir-->
                </select>
            </div>
            ...
            hacerSolicitud('aula_api.php', 'GET', null, function(status, response){
                try{
                    ...
                    aulas.forEach(aula => {
                        ...
                        option.textContent = `${aula.nombre} (${aula.estado})`;
