    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasSidebar" aria-labelledby="offcanvasSidebarLabel">
        ...
        <div class="offcanvas-body">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="gestion_solicitudes.php">Solicitudes</a>
                </li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary"
                                onclick="confirmarAceptar()">Confirmar</button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            ${solicitud.estado === 'pendiente' ? `
                                <td class="action-buttons">
                                    <button class="btn btn-success btn-sm" onclick="aceptarSolicitud(${solicitud.id_solicitud}, ${solicitud.id_anonimo}, '${solicitud.rol_propuesto}')">Aceptar</button>
                                    <button class = "btn btn-danger btn-sm" onclick="rechazarSolicitud(${solicitud.id_solicitud})">Rechazar</button>
                                </td>    
                                ` : ''}
                            </tr>
                            `;
