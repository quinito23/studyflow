...
<body>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasSidebar" aria-labelledby="offcanvasSidebarLabel">
        ...
        <div class="offcanvas-body">
            <!--Elementos de la barra lateral , es decir, las paginas-->
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link active" href="gestion_profesores.php">Profesores</a>
                </li>
                <li class="nav-item">
    ...
    <script src="../validacion.js"></script><!--Script para validaciones-->
    <script>
                        ...
                        row.innerHTML = `
                            ...
                            <td>
                                <div class="action-buttons">
                                    <button class="btn btn-info btn-sm" onclick="mostrarInfo(${profesor.id_usuario})">
                                        <i class="bi bi-info-circle"></i>
                                    </button>
                                    <button class="btn btn-success btn-sm" onclick="editarProfesor(${profesor.id_usuario})">
                                        <i class="bi bi-pencil-square"></i>
                                    </button>
                                    <button class="btn btn-danger btn-sm" onclick="eliminarProfesor(${profesor.id_usuario})">
